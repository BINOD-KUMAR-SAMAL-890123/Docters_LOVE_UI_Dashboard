const FreeCard = () => {
  return (
    <div className="relative mt-12 flex w-[256px] justify-center rounded-[20px] bg-gradient-to-br from-[#868CFF] via-[#432CF3] to-brand-500 pb-4">
      ...
      <div className="mt-16 flex h-fit flex-col items-center">
        <p className="text-lg font-bold text-white">Admin Contact</p>
        <p className="mt-1 px-4 text-center text-sm text-white">
          For any hospital-related support.
        </p>

        <div className="mt-4 text-center text-white text-sm space-y-1">
          <p>
            <strong>Email:</strong> admin@hospital.in
          </p>
          <p>
        ...
        <a
          href="mailto:admin@hospital.in"
          className="text-medium mt-3 block rounded-full bg-white/20 py-[10px] px-10 text-base text-white hover:bg-white/30 transition"
        >
          Email Admin
        </a>
      </div>
